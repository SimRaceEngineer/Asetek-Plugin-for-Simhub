...
def rendu(T, lus, depuis):
    L = ["=" * LARGE,
         ...
         "",
         "  TEMOIN  ce qu aurait rendu une VENTE SYSTEMATIQUE sur",
         "          EXACTEMENT la meme fenetre : meme instrument, meme",
         "          instant d entree, meme instant de sortie, sans",
         "          aucun signal. Il partage tout avec le trade reel",
         "          sauf la decision.",
         "  APPORT  reel - temoin. LE chiffre. Positif : le signal",
         "          ajoute quelque chose. Nul : il ne fait qu encaisser",
         "          la derive du marche, et s inversera avec elle.",
         "  t       Student apparie sur (reel - temoin), trade par",
         "          trade. Au-dela de 2 en valeur absolue, l apport",
         "          tient difficilement du hasard.",
         "",
    ...
    L += ["",
          ...
          "  change de signe d un jour a l autre laisse un apport",
          "  stable : c est une competence. Une derive constamment",
          "  negative avec un apport nul : c est aout 2026.",
          "",
